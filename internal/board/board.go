...
var registry = []Board{
	...
	// ─── CaptainDMA M2 x1 (35T, CSG325 package) ───────────────
	{
		...
		FPGAPart:   "xc7a35tcsg325-2",
		PCIeLanes:  1,
		TopModule:  "pcileech_captaindma_m2_top",
	...
	// ─── CaptainDMA 4.1th (35T, FGG484 package) ───────────────
	{
		...
		FPGAPart:   "xc7a35tfgg484-2",
		PCIeLanes:  1,
		TopModule:  "pcileech_captaindma_35t_top",
		ProjectDir: "CaptainDMA",
		SubDir:     "35t484_x1",
	...
	// ─── CaptainDMA 75T ────────────────────────────────────────
	{
		...
		FPGAPart:   "xc7a75tfgg484-2",
		PCIeLanes:  1,
		TopModule:  "pcileech_captaindma_75t_top",
		ProjectDir: "CaptainDMA",
		SubDir:     "75t484_x1",
	...
	// ─── CaptainDMA 100T ───────────────────────────────────────
	{
		...
		PCIeLanes:  1,
		TopModule:  "pcileech_captaindma_100t_top",
		ProjectDir: "CaptainDMA",
		SubDir:     "100t484-1",
	...
	// ─── LiteFury (RHS Research LiteFury) ──────────────────────
	{
		...
		FPGAPart:   "xc7a100tfgg484-2",
		PCIeLanes:  4,
		TopModule:  "pcileech_litefury_top",
		ProjectDir: "acorn_ft2232h",
