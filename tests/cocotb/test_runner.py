...
class SourceContractTests(unittest.TestCase):
    ...
    def test_root_makefile_checks_interpreters_before_pip_and_uses_safe_clean(self) -> None:
        ...
        self.assertIn("COCOTB_STABLE_CASES := nvme generic audio xhci wifi sata gpu", source)
        self.assertIn("COCOTB_EXPERIMENTAL_CASES := ethernet", source)
        self.assertIn("COCOTB_CASES ?= $(COCOTB_STABLE_CASES)", source)
