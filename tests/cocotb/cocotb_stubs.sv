...
module fifo_141_141_clk1_bar_wr (input wire srst, input wire clk, input wire [140:0] din, input wire wr_en, input wire rd_en, output wire [140:0] dout, output wire full, output wire empty, output wire prog_empty, output wire valid);
    assign dout = 0; assign full = 0; assign empty = 1; assign prog_empty = 1; assign valid = 0;
endmodule
